...
final myBox = Hive.box('masterViewDataBase');

class MasterViewDataBaseControllerNotifier extends StateNotifier<List> {
  final Ref ref;
  MasterViewDataBaseControllerNotifier(this.ref) : super([]) {
    // loadData();
  }
